...
public class RedFarCenter extends AutoPath {
    ...
    public RedFarCenter(Auto robot) {
        ...
        trajCenter = robot.drivetrain.newTraj()
                ...
                .splineToConstantHeading(new Vector2d(54.5,-39), Math.toRadians(0))
                .addTemporalMarker(() -> {
                    robot.pixels.deliverFirst(false);
                })
                .lineToConstantHeading(new Vector2d(54.5,-46))
                .addTemporalMarker(() -> {
                    robot.pixels.deliverSecond();
                })
                //park
                .setReversed(true)
        ...
        trajRight = robot.drivetrain.newTraj()
                ...
                .turn(Math.toRadians(-90))
                .lineTo(new Vector2d(21, -12))
                .splineToConstantHeading(new Vector2d(54.5,-46), Math.toRadians(0))
                .addTemporalMarker(() -> {
                    robot.pixels.deliverFirst(true);
                })
                //park
