...
public class BlueCloseCenter extends AutoPath {
    ...
    public BlueCloseCenter(Auto robot) {
        ...
        trajCenter = robot.drivetrain.newTraj()
                ...
                .splineToConstantHeading(new Vector2d(54,37), Math.toRadians(0))
                .addTemporalMarker(() -> {
        ...
        trajRight = robot.drivetrain.newTraj()
                ...
                .splineToConstantHeading(new Vector2d(54,31), Math.toRadians(0))
                .addTemporalMarker(() -> {
                    robot.pixels.deliverFirst(true);
                })
                //park
