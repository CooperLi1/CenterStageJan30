...
public class RedClose60pt extends AutoPath {
    ...
    private boolean reextend = true;

    public RedClose60pt(Auto robot) {
        super(robot);
        robot.pixels.setkP(0.024);
        Pose2d startPose = new Pose2d(12, -63, Math.toRadians(90));

        robot.drivetrain.setPose(startPose);
        centerPreload = robot.drivetrain.newTraj(startPose)
                //purple
                .lineToConstantHeading(new Vector2d(12, -34.5))
        ...
        centerCycleIntake = robot.drivetrain.newTraj(centerPreload.end())
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(24,-14), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(-16.5, -14), Math.toRadians(180))
                .build();
