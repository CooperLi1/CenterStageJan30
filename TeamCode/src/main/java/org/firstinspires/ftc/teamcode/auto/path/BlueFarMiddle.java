...
public class BlueFarMiddle extends AutoPath {
    ...
    public BlueFarMiddle(Auto robot) {
        super(robot);
        ...
        rightPurple = robot.drivetrain.newTraj(startPose)
                ...
                .lineToConstantHeading(new Vector2d(-36, 56))
        ...
        centerYellow = robot.drivetrain.newTraj(centerPurple.end())
                ...
                .splineToConstantHeading(new Vector2d(51, 37), Math.toRadians(0), SampleMecanumDrive.VEL_CONSTRAINT, SampleMecanumDrive.getAccelerationConstraint(15))
                .build();
        ...
        leftYellow = robot.drivetrain.newTraj(leftPurple.end())
                ...
                .splineToConstantHeading(new Vector2d(51, 46), Math.toRadians(0), SampleMecanumDrive.VEL_CONSTRAINT, SampleMecanumDrive.getAccelerationConstraint(15))
                .build();

        parkCenter = robot.drivetrain.newTraj(rightYellow.end())
                .lineToConstantHeading(new Vector2d(44, 16.5))
                .build();
        parkWall = robot.drivetrain.newTraj(leftYellow.end())
